...
// ---- AI CLI widget (mirror of src-tauri/src/ai_cli/model.rs) ----------------

/** Mirrored in `src-tauri/src/ai_cli/model.rs::UnseenFailure`. */
export interface UnseenFailure {
  cli_id: string;
...
/** Mirrored in `src-tauri/src/ai_cli/model.rs::AggregateState`. */
export interface AggregateState {
  has_unseen_failure: boolean;
  any_running: boolean;
  any_finished: boolean;
  per_cli: CliSnapshot[];
}

/** Mirrored in `src-tauri/src/ai_cli/model.rs::CliSnapshot`. */
...
/** Mirrored in `src-tauri/src/ai_cli/model.rs::CliDetected`. */
